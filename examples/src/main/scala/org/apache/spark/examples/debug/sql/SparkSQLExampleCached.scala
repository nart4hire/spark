 ...
 */
package org.apache.spark.examples.debug.sql
...
object SparkSQLExampleCached {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession
      .builder()
      .appName("Spark SQL basic example Cached")
  ...
  private def runBasicDataFrameExample(spark: SparkSession, args: String): Unit = {
    ...
    val sqlDF = spark.sql("SELECT * FROM people").cache()
    sqlDF.show()
    // +----+-------+
    // | age|   name|
    // +----+-------+
    ...
    spark.sql("SELECT * FROM global_temp.people").cache().show()
    // +----+-------+
    // | age|   name|
    // +----+-------+
    // |null|Michael|
    ...
    spark.newSession().sql("SELECT * FROM global_temp.people").cache().show()
    // +----+-------+
    // | age|   name|
    // +----+-------+
    // |null|Michael|
